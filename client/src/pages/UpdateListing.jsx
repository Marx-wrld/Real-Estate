        ...
        <main className="p-3 max-w-4xl mx-auto">
            ...
            <form className="flex flex-col sm:flex-row gap-4" onSubmit={handleSubmit}>
                ...
                <div className="flex flex-col flex-1 gap-4">
                    ...
                    <button disabled={loading || uploading} className="p-3 bg-slate-700 text-white rounded-lg mt-4 uppercase hover:opacity-95 disabled:opacity-80">{loading ? 'Updating...' : 'Update Listing'}</button>
