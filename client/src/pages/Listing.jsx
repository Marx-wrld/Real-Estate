        ...
        <>
          ...
          <div className='flex flex-col max-w-4xl mx-auto p-3 my-7 gap-4'>
            <p className='text-2xl font-semibold'>
              {listing.name} - ${' '}
              {listing.offer // if there is an offer, then show the discount price, else show the regular price
            ...
            <div className='flex gap-4'>
              ...
              {listing.offer && ( // if there is an offer, then show the discount
            ...
            <ul className='text-green-800 font-semibold text-sm flex flex-wrap items-center gap-4 sm:gap-6'>
              <li className='flex items-center gap-1 whitespace-nowrap'>
                ...
                {listing.bedrooms > 1 // // if bedrooms is greater than 1, then add an 's' to the end of the word 'bed'
                  ? `${listing.bedrooms} beds `
                  : `${listing.bedrooms} bed `}
              </li>
              <li className='flex items-center gap-1 whitespace-nowrap '>
                <FaBath className='text-lg' />
                {listing.bathrooms > 1 // if bathrooms is greater than 1, then add an 's' to the end of the word 'bath'
